...
export class GasPacService {
  ...
  public coloresDeSeguridad: Array<any> = [
    ...
    {
      pregunta: '¿Están claramente marcados los pasillos con líneas pintadas?',
      respuesta: undefined,
      comentarios: '',
      image: ''
    },
  ...
  public equipoDeProteccionContraIncendio: Array<any> = [
    {
  ...
  public equipoDeGasYAireComprimido: Array<any> = [
    {
  ...
  public sustanciasToxicasYPeligrosas: Array<any> = [
    {
