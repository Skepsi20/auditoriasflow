...
export class Planta52Service {
  ...
  public coloresYSegnalesDeSeguridad: Array<any> = [
    {
      ...
      pregunta: 'Existe alguna señal de seguridad obsoleta o que ya no cumpla con la función para la cual se colocó inicialmente',
      respuesta: undefined,
      comentarios: '',
      image: ''
    },
  ...
  public controlesAmbientalesGeneralesYPrimerosAuxilios: Array<any> = [
    {
      pregunta: '¿Se mantienen limpios y en buenas condiciones los baños?',
      respuesta: undefined,
      comentarios: '',
      image: ''
    },{
      ...
      pregunta: '¿Son suficientes los suministros de primeros auxilios?',
      respuesta: undefined,
      comentarios: '',
      image: ''
    },{
  ...
  public sustanciasToxicasYPeligrosasPlanta52: Array<any> = [
    {
